...
const PLANS = {
  '2k_2phase':   { accountSize: 2000,   priceUsd: 2,   phase: '2-Phase' },
  ...
  '2k_1phase':   { accountSize: 2000,   priceUsd: 5,   phase: '1-Phase' },
  '5k_1phase':   { accountSize: 5000,   priceUsd: 9,   phase: '1-Phase' },
  '10k_1phase':  { accountSize: 10000,  priceUsd: 29,  phase: '1-Phase' },
  '25k_1phase':  { accountSize: 25000,  priceUsd: 69,  phase: '1-Phase' },
  '50k_1phase':  { accountSize: 50000,  priceUsd: 139, phase: '1-Phase' },
  '100k_1phase': { accountSize: 100000, priceUsd: 269, phase: '1-Phase' }
};
...
app.post('/api/orders/:ref/submit-txid', auth, (req, res) => {
  try {
    ...
    res.json({ ok: true, message: 'TXID submitted. Verification within 24 hours.' });
